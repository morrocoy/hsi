...
class DemoWindow(QtWidgets.QMainWindow):
    ...
    def _setupViews(self, cmap, showHistogram):
        ...
        self.controlItem1 = RegnImagCtrlItem(label="ImageHistControlItem21", cmap=cmap, showHistogram=showHistogram, cbarWidth=10)
        self.controlItem1.setData({'a': img1, 'b': img2})
        self.controlItem2 = RegnImagCtrlItem(label="ImageHistControlItem2", cmap=cmap, showHistogram=showHistogram, cbarWidth=10)
        self.controlItem2.setData({'a': img1, 'b': img2})

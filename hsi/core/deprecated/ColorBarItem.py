...
class ColorBarItem(pg.GraphicsWidget):
    ...
    def __init__(self,
        ...
        """ Constructor.
            ...
            :param orientation: Can be a 'right' or 'bottom'.
    ...
    def _updateHistogram(self):
        ...
        """
        if not self._histogramIsVisible or self._imageItem is None or self._imageItem.getImage is None:
            self.histPlotDataItem.clear()
            return

        try:
            imgArr = self._imageItem.getImage
